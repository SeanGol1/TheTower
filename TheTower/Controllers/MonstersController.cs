...
namespace TheTower.Controllers
{
    ...
    .ToListAsync());
        ...
        public async Task<IActionResult> Create([Bind("ID,ChallengeRating,Name,XP,RollNumber,ImagePath")] Monster monster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,ChallengeRating,Name,XP,RollNumber,ImagePath")] Monster monster)
        {
            if (id != monster.ID)
            {
                return NotFound();
